...
'//
'//  ファイル名  ：frmVerUpdateIkkatsu.frm
'//  パッケージ名：改札機バージョン一括更新中画面
'//
...
'//                 北陸新幹線開業対応
'//  REVISIONS   ：(EG20 V30.2.0.1) 2014-06-20  CODED BY  [TCC] T.Nakajima
'//                 アクティブ要求対応
...
Private Sub Form_Load()
    ...
    'udtMail.dwRequest = ML_REQUEST_EG20GATE  '自改バージョン情報更新要求の種別     'EG20 V30.1.0.1 DEL
    'EG20 V30.1.0.1 ADD START
    If gStrCurrentForm = sFormName_GateVerUpdate Then
        udtMail.dwRequest = ML_REQUEST_EG20GATE     '自改バージョン情報更新要求の種別
    Else
        udtMail.dwRequest = ML_REQUEST_EG30GATE     'EG30自改バージョン情報
    End If
...
'EG20 V30.1.0.2 DEL START
                'EG20 V30.1.0.1 ADD START
'                If gStrCurrentForm = sFormName_GateVerUpdate Then   '自改バージョン一括更新画面
'                    gStrCurrentForm = sFormName_GateVerUpdate
'                    AppActivate frmGateVerUpdate.Caption, False
'                    pfFormActive (frmGateVerUpdate.hwnd)
'                Else                                                '新幹線自改バージョン一括更新画面
