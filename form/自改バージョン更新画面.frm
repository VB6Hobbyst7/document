...
Begin VB.Form frmGateVerUpdate 
   BorderStyle     =   0  'なし
   Caption         =   "Form1"
   ClientHeight    =   9000
   ClientLeft      =   0
   ...
   End
End
Attribute VB_Name = "frmGateVerUpdate"
...
Private Const NGATE_00 = -1                     'TOMAS領域フォルダ  EG20 V30.3.0.1 ADD
...
Private Sub Form_Load()
    ...
    Call sLogTraceReq(LTYP_NORMAL, L3AN_ETC, JIKAI_VERASION_IKKATSU_KANRI_GAMEN_START, 0)
    ...
    For intLoop = 0 To CONECT_CORNER_MAXINDEX
        ...
        If gudtSettiCorner(intLoop).intGokiNum > 0 Then
            ...
            '在来コーナーのみ押下可能とする。
'            If gintCornerType(intLoop) = CORNER_TYPE_ZAIRAI Then
...
Private Sub cmdModoru_Click()
    ...
    Call sLogTraceReq(LTYP_NORMAL, L3AN_ETC, JIKAI_VERASION_IKKATSU_KANRI_GAMEN_END, 0)
...
Private Sub cmdSelectAll_Click()
    ...
    Call sLogTraceReq(LTYP_NORMAL, L3AN_ETC, JIKAI_VERASION_IKKATSU_KANRI_SELECTALL_BUTTON, 0)
...
Private Sub cmdSelectNone_Click()
    ...
    Call sLogTraceReq(LTYP_NORMAL, L3AN_ETC, JIKAI_VERASION_IKKATSU_KANRI_SELECTALLOFF_BUTTON, 0)
...
Private Sub chkUpdate_Click(Index As Integer)
    ...
    Call sLogTraceReq(LTYP_NORMAL, L3AN_ETC, JIKAI_VERASION_IKKATSU_KANRI_SELECT_BUTTON, 0)
...
'//  REVISIONS   ： (EG20 V5.13.0.1) 2012-06-02 REVISED BY  [TCC] H.Sugimoto
'//                 【プログレスバー表示機能見直し対応】
'//  REVISIONS   ： (EG20 V30.3.0.1) 2014-11-11 REVISED BY  [TCC] T.Nakajima
'//                  北陸新幹線フェーズ２対応 【HKRK_Kansi06_004_02】
'//  REVISIONS    : (x.x.x.x) xxxx-xx-xx   CODED   BY [xxx]
'//  備考         :
'/////////////////////////////////////////////////////////////////////////////
            ...
            If chkUpdate(iCornerLoop).Value = SELECTSW_ON_VALUE Then
                For iSelctLoop = 0 To 8
                    If optData(iSelctLoop).Value = SELECTSW_ON_VALUE Then
                        ...
                        'EG20 V30.3.0.1 【HKRK_Kansi06_004_02】 ADD START
                        If iTomasFlg = 0 Then
                            bStatus = fOldVersion(NGATE_00) 'TOMAS領域に対して行う。
                            'Call AddMessageLstStatus(NGATE_00, FolderSyubetu, bStatus)
                        End If
                        'EG20 V30.3.0.1 【HKRK_Kansi06_004_02】 ADD END
...
Private Sub sCmdBtnEnabled(blnFlg As Boolean)
    ...
    For iLoopCnt = 0 To CONECT_CORNER_MAXINDEX
        ...
        'EG20 V30.1.0.1 ADD START
        '在来コーナーに対してのみ設定可能とする。
'        If gintCornerType(iLoopCnt) = CORNER_TYPE_ZAIRAI Then
...
' EG20 V6.9.0.1 【量産対応：TOMAS用領域コピー対応】ADD START
    ...
    'If nCorner = gintZairaiFirstCornerIdx Then      'EG20 V30.1.0.1 ADD
    'EG20 V30.3.0.1 【HKRK_Kansi06_004_02】 DEL END
...
'        AppActivate frmJVer.Caption, False             ' EG20 V8.1.0.1【EG20_KANSI05_01】DEL
        AppActivate frmGateVerUpdate.Caption, False     ' EG20 V8.1.0.1【EG20_KANSI05_01】ADD
        pfFormActive (frmGateVerUpdate.hwnd)            ' EG20 V8.1.0.1【EG20_KANSI05_01】ADD
    End If
End Sub
